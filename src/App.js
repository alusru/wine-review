...
<ReactiveBase app="wine" url="ADD_AN_APPBASE.IO_URL"> {/** appbase url can be found after creating an index and cluster */}
...
<section id="sidebar">
    ...
    <div className="container">
        ...
        <div key={item._id} id="items" className="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                        <div className="card"> 
